...
| Metric | Scenario B (Cold Start / Random) | Scenario A (Warm Cache / Repetition) | Improvement |
| :--- | :--- | :--- | :--- |
| **Total Token Throughput** | 4,065.94 tok/s | **7,818.65 tok/s** | **~1.9x Faster** |
| **Request Throughput** | 0.39 req/s | **0.74 req/s** | **~1.9x Capacity** |
| **Peak Output Token Throughput** | 658.00 tok/s | **869.00 tok/s** | **+32%** |
| **Successful Requests** | 50 | **80** | N/A |
| **Total Input Tokens Processed** | 500,000 | **820,480** | N/A |
| **Total Generated Tokens** | 15,000 | **22,493** | N/A |
